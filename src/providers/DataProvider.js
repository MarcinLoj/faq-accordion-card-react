const data = [
    {
        ...
        desc: "You can invite up to 2 additional users on the Free plan. There is no limit on " +
    ...
    },
    {
        ...
        desc:  "Click “Forgot password” from the login page or “Change password” from your profile page." +
